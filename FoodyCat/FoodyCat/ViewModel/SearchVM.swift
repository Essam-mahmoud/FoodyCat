...
class SearchVM: ViewModel {
    ...
    func getCeleberities(celebrityName: String, onComplete: @escaping(_ errorMessage : String?,_ ErrorResponse:ResponseModel?, _ state:State)->()) {
        let params = ["searchKey": celebrityName] as [String : Any]

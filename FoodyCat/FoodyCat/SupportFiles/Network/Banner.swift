...
//       static let AppColor = UIColor(red:19.0/255.0, green:17.0/255.0, blue:49.0/255.0, alpha:1.000)
...
//    @objc public required init(title: String? = nil, subtitle: String? = nil, image: UIImage? = nil, backgroundColor: UIColor = .black, didTapBlock: (() -> ())? = nil) {
